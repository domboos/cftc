...
#ov = pd.DataFrame({'net': c['pos']}) # kann zu 90% gelöscht werden.
...
#get VIX data: 
vix = pd.read_excel('Daten_v1\\vix.xlsx', index_col=0)
...
plt.figure(str(ind)+ '_coef')
plt.plot(coefA)
plt.title('some loadings for the dod diff model, market:' + str(ind))
